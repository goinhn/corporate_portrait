...
import com.goinhn.portrait.model.BusinessManagementAbilityValue;
 ...
 */
@Repository
public interface BusinessManagementAbilityValueMapper {

    /**
     * 根据公司名称返回分析数据
     *
     * @param businessManagementAbilityValue 公司名称
     * @return
     */
    @Select("select * from tab_business_management_ability_value where entname = #{entName}")
    @Results(
    ...
    BusinessManagementAbilityValue selectAllByEntName(BusinessManagementAbilityValue businessManagementAbilityValue);
}
