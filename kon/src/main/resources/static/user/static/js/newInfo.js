...
function submitNow() {
    ...
    let token = localStorage.getItem("token");
    let url = localUrl + '/kon/save/searchEntName/' + entName + '?token=' + token;
...
function sendBackFormInfo() {
    ...
    let token = localStorage.getItem("token");
    let url = localUrl + '/kon/save/saveNewInfo' + '?token=' + token;
...
function sendBackOriginalAnalysisLabel(data) {
    ...
    let token = localStorage.getItem("token");
    let url = localUrl + '/kon/save/saveNewOriginalAnalysisLabel' + '?token=' + token
