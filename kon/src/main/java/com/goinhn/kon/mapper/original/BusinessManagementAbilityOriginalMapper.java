...
import com.goinhn.kon.model.entity.original.BusinessManagementAbilityOriginal;
...
public interface BusinessManagementAbilityOriginalMapper {
     ...
     * @return
     */
    @Delete("delete from tab_business_management_ability_original where eid = #{eid}")
